...
use syn::{
    meta::ParseNestedMeta, punctuated::Punctuated, token::Comma, Attribute, Data, DataStruct,
    Error, Expr, Field, Fields, GenericArgument, Generics, LitBool, LitStr, PathArguments, Token,
...
pub(crate) fn process_input(
    ...
    let (fields, is_named) =
        extract_fields(&data).expect("Input should already be validated by find_type");
